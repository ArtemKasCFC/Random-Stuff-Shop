...
var addToCart = exports.addToCart =
/*#__PURE__*/
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
...
},{"axios":"../../node_modules/axios/index.js"}],"shoppingCart.js":[function(require,module,exports) {
"use strict";
...
var changeQuantity = exports.changeQuantity =
/*#__PURE__*/
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee(productName, quantity) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
var _cartMain = require("./cartMain.js");
...
addToCartBtns.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    e.preventDefault();
    var title = this.previousElementSibling.querySelector('.product-title').textContent;
    (0, _cartMain.addToCart)(title);
  });
}); // Images Slider
...
var OBSbtn = document.querySelector('.hero-btn');

if (OBSbtn) {
  document.querySelector('.hero-btn').addEventListener('click', function (e) {
    e.preventDefault();
    var href = OBSbtn.getAttribute('href');
